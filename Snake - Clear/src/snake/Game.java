...
import snake.Command.DownCommand;
import snake.Command.LeftCommand;
import snake.Command.RightCommand;
import snake.Command.UpCommand;
...
public class Game extends Canvas implements Runnable, KeyListener {
    ...
    public static Game getInstance(){
        if(uniqueInstance == null) uniqueInstance = new Game(800, 700);
    ...
    public void keyPressed(KeyEvent e) {
        ...
        case KeyEvent.VK_UP:
        case KeyEvent.VK_W:
            snake.setDirection(Snake.UP, new UpCommand());
            break;
        case KeyEvent.VK_DOWN:
        case KeyEvent.VK_S:
            snake.setDirection(Snake.DOWN, new DownCommand());
            break;
        case KeyEvent.VK_LEFT:
        case KeyEvent.VK_A:
            snake.setDirection(Snake.LEFT, new LeftCommand());
            break;
        case KeyEvent.VK_RIGHT:
        case KeyEvent.VK_D:
            snake.setDirection(Snake.RIGHT, new RightCommand());
            break;
